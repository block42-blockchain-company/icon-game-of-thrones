...
Now copy the scoreAddress (cx8f97bdfa6ce30b3ab11cb606ac1c54862cbbd36c) from the transaction result, open the call_score_functions.py file and
replace the content of the scoreAddress variable with the actual hexNumber you just copied.
